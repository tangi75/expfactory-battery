...
var instructions_block = {
  ...
  pages: [
	...
	'<div class = centerbox><p class = block-text>To summarize, you will keep track of three different tones: low, medium and high. When you count 4 of any tone, press the spacebar. After you respond to a tone (regardless of if you were correct or not), mentally reset that tones count, while leaving the count for the other tones intact.</p><p class = block-text>Press <strong>enter</strong> to hear the three tones.</p></div>'
	],
  key_forward: 13
};
...
var tone_introduction_block = {
  ...
  stimuli: ['static/sounds/tone_monitoring/880Hz_-6dBFS_.5s.mp3',
			'static/sounds/tone_monitoring/440Hz_-6dBFS_.5s.mp3',
			'static/sounds/tone_monitoring/220Hz_-6dBFS_.5s.mp3'],
  choices: 'none',
  timing_stim: 2500,
