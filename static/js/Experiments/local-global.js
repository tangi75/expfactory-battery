...
var instructions_block = {
  ...
  pages: [
	...
	'<div class = centerbox><p class = block-text>For instance, for the shape below you would press 3 because it is ' + task_colors[1] + ' which means you should respond based on the smaller shapes. If the shape was instead ' + task_colors[0] + ' you would press 2.</p><img src = "../Local-global/stim/' + task_colors[1] + '_Xoftriangles.png" height = 200 width = 200></img><br><br><p class = "block-text">Use the <strong>right arrow key</strong> to advance through the instructions. You can go back using the <strong>left arrow key</strong>.</p></div>'
	]
};
