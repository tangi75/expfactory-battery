...
var start_test_block = {
  type: 'text',
  text: '<div class = centerbox><p class = block-text>We will now start the test. Respond exactly like you did during practice.</p><p class = block-text>Press <strong>enter</strong> to begin the test.</p></div>',
  cont_key: 13
};

var fixation_block = {
  type: 'single-stim',
  stimuli: '<div class = centerbox><div class = stroop_fixation>+</div></div>',
  is_html: true,
  choices: 'none',
...
for (i=0; i<practice_len; i++) {
	...
	var practice_block = {
	  ...
	  correct_text: '<br></br><p class = center-text><font size = 20>Correct</font></p>',
	  incorrect_text: '<br></br><p class = center-text><font size = 20>Incorrect</font></p>',
	  choices: [66,71,82],
